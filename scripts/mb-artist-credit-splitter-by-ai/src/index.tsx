...
function copiedArtistCreditToPlainString(artistCredit: MBCopiedArtistCredit["names"]): string {
...
GM.registerMenuCommand("Split clipboard content (OpenRouter)", () => {
    ...
    let apiKey = GM_getValue<string | undefined>("openrouter_api_key")
    if (apiKey == null) {
