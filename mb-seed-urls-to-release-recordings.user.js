...
(function () {
    ...
    function applyRelationships(relationships, editNote, relationshipEditor) {
        ...
        if (tree == null)
            return alert("MB.tree is missing.");
        ...
        for (const relationship of relationships) {
            ...
            const existingRels = relationship.recording.relationships
                ...
                .filter(r => r.target_type === "url" && r.target.href_url === relationship.url && (relationship.linkTypeID === "all" || r.linkTypeID === relationship.linkTypeID))
                .toSorted((a, b) => {
                if (a.ended !== b.ended) {
            ...
            if (relationship.linkTypeID === "all")
                continue;
            relationshipEditor.dispatch({
                type: "update-relationship-state",
                sourceEntity: relationship.recording,
